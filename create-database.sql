...
CREATE TABLE iists.ROLE_CATEGORY(
	ID INT PRIMARY KEY AUTO_INCREMENT,
	ROLE_ID INT NOT NULL,
	CATEGORY_ID INT NOT NULL,
	FOREIGN KEY(CATEGORY_ID) REFERENCES iists.CATEGORY(CATEGORY_ID),
   FOREIGN KEY(ROLE_ID) REFERENCES iists.ROLES(ROLE_ID)
);
